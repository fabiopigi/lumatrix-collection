...
- **shipped** — built and merged to main (PR# noted in the idea file)

## Index

| Idea | Hook | Status | Tags |
| --- | --- | --- | --- |
| [Local design storage](local-design-storage.md) | Save, open, and manage multiple designs in the browser | shipped (#15) | web-toolkit, lumen-designer, ux, persistence |
